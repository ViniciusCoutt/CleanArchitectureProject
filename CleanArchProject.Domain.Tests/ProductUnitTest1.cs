...
namespace CleanArchProject.Domain.Tests
{
    public class ProductDomainUnitTest1
    {
        ...
        {
            Action action = () => new Product(1, "Name", "Description", 100.50m, 5, "image code", 1);
            action.Should()
        ...
        {
            Action action = () => new Product(1, "Na", "Description", 100.50m, 5, "image code", 1);
            action.Should()
                .Throw<DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "Name", "Description", -1, 5, "image code", 1);
            action.Should()
                .Throw<DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "Name", "Description", 10, -1, "image code", 1);
            action.Should()
                .Throw<DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "name", "Description", 100.50m, 5, "image code", 1).Update("name2", "Description2", 100.50m, 5, "image code2", 2);
            action.Should()
                .NotThrow<DomainExceptionValidation>();
        }
